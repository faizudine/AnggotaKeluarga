...
public class OrangTua implements AnggotaKeluarga {
    private String nama;
    ...
    public OrangTua(String nama, String tempatLahir, String tanggalLahir, String pekerjaan, String tempatTinggal) {
        this.nama = nama;
